...
switch (_that) {
case _MessageModel() when $default != null:
return $default(_that.id,_that.createdDate,_that.updatedDate,_that.senderPhoneNumber,_that.senderNameSurname,_that.receiverPhoneNumber,_that.receiverNameSurname,_that.messageType,_that.messageId,_that.imageCaption,_that.imageUrl,_that.textBody,_that.isConversation,_that.timestamp,_that.conversation);case _:
  return orElse();
...
class _MessageModel extends MessageModel {
   _MessageModel({this.id, this.createdDate, this.updatedDate, this.senderPhoneNumber, this.senderNameSurname, this.receiverPhoneNumber, this.receiverNameSurname, this.messageType, this.messageId, this.imageCaption, this.imageUrl, this.textBody, this.isConversation, this.timestamp, this.conversation}): super._();
