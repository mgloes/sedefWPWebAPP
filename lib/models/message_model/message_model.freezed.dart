...
@useResult
$Res call({
 int? id, DateTime? createdDate, DateTime? updatedDate, String? senderPhoneNumber, String? senderNameSurname, String? receiverPhoneNumber, String? receiverNameSurname, String? messageType, String? messageId, String? imageCaption, String? imageUrl, String? textBody, bool? isConversation, String? timestamp, ConversationModel? conversation, double? latitude, double? longitude, String? locationUrl
});
...
as ConversationModel?,latitude: freezed == latitude ? _self.latitude : latitude // ignore: cast_nullable_to_non_nullable
as double?,longitude: freezed == longitude ? _self.longitude : longitude // ignore: cast_nullable_to_non_nullable
as double?,locationUrl: freezed == locationUrl ? _self.locationUrl : locationUrl // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of MessageModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  DateTime? createdDate,  DateTime? updatedDate,  String? senderPhoneNumber,  String? senderNameSurname,  String? receiverPhoneNumber,  String? receiverNameSurname,  String? messageType,  String? messageId,  String? imageCaption,  String? imageUrl,  String? textBody,  bool? isConversation,  String? timestamp,  ConversationModel? conversation,  double? latitude,  double? longitude,  String? locationUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageModel() when $default != null:
return $default(_that.id,_that.createdDate,_that.updatedDate,_that.senderPhoneNumber,_that.senderNameSurname,_that.receiverPhoneNumber,_that.receiverNameSurname,_that.messageType,_that.messageId,_that.imageCaption,_that.imageUrl,_that.textBody,_that.isConversation,_that.timestamp,_that.conversation,_that.latitude,_that.longitude,_that.locationUrl);case _:
  return orElse();
...
class _MessageModel extends MessageModel {
   _MessageModel({this.id, this.createdDate, this.updatedDate, this.senderPhoneNumber, this.senderNameSurname, this.receiverPhoneNumber, this.receiverNameSurname, this.messageType, this.messageId, this.imageCaption, this.imageUrl, this.textBody, this.isConversation, this.timestamp, this.conversation, this.latitude, this.longitude, this.locationUrl}): super._();
